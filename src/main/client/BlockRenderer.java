...
import solucraft.blocks.BlockCamoFull;
import solucraft.blocks.BlockOneWay;
...
public class BlockRenderer implements ISimpleBlockRenderingHandler
{
    ...
    {
        return renderID == ModBlocks.render3DId;
    }
