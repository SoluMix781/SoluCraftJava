...
public class TileEntityIronChest extends TileEntity implements IInventory {
    ...
    public void updateEntity()
    {
        ...
        {
            worldObj.addBlockEvent(xCoord, yCoord, zCoord, SoluCraft.ironChestBlock, 3, ((numUsingPlayers << 3) & 0xF8) | (facing & 0x7));
        }
    ...
    public void openInventory()
    {
        ...
        numUsingPlayers++;
        worldObj.addBlockEvent(xCoord, yCoord, zCoord, SoluCraft.ironChestBlock, 1, numUsingPlayers);
    }
    ...
    public TileEntityIronChest applyUpgradeItem(ItemChestChanger itemChestChanger)
    {
        ...
        BlockIronChest block = SoluCraft.ironChestBlock;
    ...
    void rotateAround(ForgeDirection axis)
    {
        ...
        worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, SoluCraft.ironChestBlock, 2, getFacing());
    }
