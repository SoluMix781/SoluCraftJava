...
public class BlockCamoPlate extends BlockCamoFull
{
    ...
    {
        if (players)
            blockIcon = par1IconRegister.registerIcon(Reference.TEXTURE_BLOCK_PLATE_PLAYER);
        else
            blockIcon = par1IconRegister.registerIcon(Reference.TEXTURE_BLOCK_PLATE_WOOD);
    }
