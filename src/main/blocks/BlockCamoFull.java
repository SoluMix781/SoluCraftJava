...
import solucraft.common.BlockHolder;
...
public class BlockCamoFull extends BlockContainer
{
    ...
    {
        blockIcon = par1IconRegister.registerIcon(Reference.TEXTURE_BLOCK_BASE);
    }
    ...
    public final ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z)
    {
        try
        {
            ...
            SoluCraft.proxy.getFakeWorld(world);
    ...
    public final int getLightOpacity(IBlockAccess world, int x, int y, int z)
    {
        ...
        {
            TileEntityCamo entity = (TileEntityCamo) world.getTileEntity(x, y, z);
            FakeWorld fake = SoluCraft.proxy.getFakeWorld(entity.getWorldObj());
    ...
    public int getFlammability(IBlockAccess iba, int x, int y, int z, ForgeDirection face)
    {
        ...
        if (entity != null)
        {
            ...
            if (id != 0)
                return Block.getBlockById(id).getFlammability(SoluCraft.proxy.getFakeWorld(world), x, y, z, face);
        }
