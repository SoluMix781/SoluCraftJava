...
public class TileEntityCamoChest extends TileEntityCamo implements IInventory
{
    ...
    {
        ++numUsingPlayers;
        worldObj.addBlockEvent(xCoord, yCoord, zCoord, ModBlocks.camoChest, 1, numUsingPlayers);
        worldObj.notifyBlocksOfNeighborChange(xCoord, yCoord, zCoord, ModBlocks.camoChest);
    }
