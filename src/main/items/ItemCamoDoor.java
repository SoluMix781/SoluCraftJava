...
import solucraft.blocks.TileEntityCamo;
...
public class ItemCamoDoor extends Item
{
    ...
    public void registerIcons(IIconRegister par1IconRegister)
    {
        ...
        {
            itemIcon = par1IconRegister.registerIcon(Reference.TEXTURE_ITEM_DOOR_STEEL);
        }
        else
        {
            itemIcon = par1IconRegister.registerIcon(Reference.TEXTURE_ITEM_DOOR_WOOD);
        }
    }
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float clickX, float clickY, float clickZ)
    {
        ...
        if (doorMaterial.equals(Material.iron))
        {
            block = ModBlocks.camoDoorIron;
        }
        else
        {
            block = ModBlocks.camoDoorWood;
        }
