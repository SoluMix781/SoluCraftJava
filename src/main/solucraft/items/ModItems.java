...
public class ModItems {
	...
	public static void init() {
		...
		glass = new smoking (smoking , 0, 0).setUnlocalizedName("glass").setCreativeTab(SoluCraft.tabSoluCraftItems);
		chest = new smoking (smoking , 0, 1).setUnlocalizedName("chest").setCreativeTab(SoluCraft.tabSoluCraftItems);
		legs = new smoking (smoking , 0, 2).setUnlocalizedName("legs").setCreativeTab(SoluCraft.tabSoluCraftItems);
		boots = new smoking (smoking , 0, 3).setUnlocalizedName("boots").setCreativeTab(SoluCraft.tabSoluCraftItems);
